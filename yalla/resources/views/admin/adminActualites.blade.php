...
<main>
    <section id="admin-add-article">
        <h2><span class="more">+</span><span class="less">-</span> Nouvel article</h2>

        <div class="wrapper">
            <div class="main-content">
                <input type="text" placeholder="Entrer un titre">
                <textarea class="article-content">Next, get a free TinyMCE Cloud API key!</textarea>
            </div>
            <!-- end of main-content -->
            <div class="aside-content">
                ...
                <div class="status">
                    <span>Status</span>
                    <select name="" id="">
                        <option value="">Brouillon <i>i</i></option>
                ...
                <div class="visibility">
                    ...
                    <select name="" id="">
                        <option value="">Public <i>i</i></option>
                    </select>
                </div>
                <div class="visibility">
                    <span>Publication</span>
                    <select name="" id="">
                        <option value="">Immédiate <i>i</i></option>
                    </select>
                </div>
                <div class="add-tags">
                    <span>Tags (3 maximum)</span>
                    <input type="text" name="tags" placeholder="Commencez à taper...">
                    <input type="hidden" name="tags" value="">
                    <div class="all-tags">
                        <span class="tag"><i>x</i>salut</span>
                    </div>
                </div>
    ...
    <section id="admin-all-articles">
        ...
        <div id="admin-view-articles">
            ...
            <div class="pagination">
                ...
                <span class="arrow"><</span>
                <span>Page <b>1</b> sur <b>4</b></span>
                <span class="arrow">></span>
                <span class="arrow">>></span>
            </div>
            <!-- end of pagination -->
